...
@section('content')
        <div class="main" style="marginbottom: 10px;">
                                ...
                                <div class="row" style="margin-bottom: 33px;">
                                        ...
                                        <div class="col-md-9 main_board" style="padding-right: 20px;">
                                                ...
                                                <div class="row" style="padding: 0px 15px;">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                                                                <article class="story_block">
                                                                                        <figure class="story_img">
                                                                                                ...
                                                                                                <div class="img_view" style="overflow: hidden">
                                                                                                        <?php
                                                        ...
                                                        echo "<img src='".$img_d."' layout='responsive' class='text-center img_view ' alt='".$b_c->title."' height='330' width='300' style='max-height: 330px;'   />";;
                                                    }else{
                                                                                    ...
                                                                                    @if(isset($sidebar[$k]))
                                                                                        <div class="da x728 visible-xs">
                                                                                            @if($sidebar->count() >0 )
                                                                                                ...
                                                                                                @else
                                                                                                    <a href="{{ $sb->url }}">
                                                                                                        <img src="{{ str_replace("alexis.","www.",$sb->image_url) }}" alt="advert banner"/>
                                                                                                    </a>
                                                                                                @endif
                                                                                                <div class="clearfix"></div>
                                                                                                <br/>
                                                                                                    ...
                                                                                                    @if(isset($inbtw[$j]))
                                                                                                            <div class="da x728 visible">
                                                                                                                    ...
                                                                                                                    @if($inbtw[$j]['advert_type'] == "0"  || $inbtw[$j]['advert_type'] == null)
                                                                                                                        ...
                                                                                                                        @else
                                                                                                                            <a href="{{ $inbtw[$j]['url'] }}">
                                                                                                                                    <img src="{{ str_replace("alexis.","www.",$inbtw[$j]['image_url']) }}" layout='responsive' alt="advert banner"/>
                                                                                                                                </a>
                                                                                                                        @endif
                                                                                                                </div>
                                                                                                        @endif
