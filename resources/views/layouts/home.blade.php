...
<head>
    ...
    <noscript><img src="https://certify.alexametrics.com/atrk.gif?account=2SUWo1IWhd10/9"
    ...
    <meta name="google-signin-client_id"
        content="783508407836-61bsogdsngcs1sa942fromqbgchojer6.apps.googleusercontent.com">
    <meta charset="utf-8">
    ...
    <meta name="keywords"
        content="{{ (isset($keywords) ? $keywords : "blogs") }},news, blog, politics, gossip, Events, Entertainment, Lifestyle, Fashion, Beauty, Inspiration">
    <meta property="article:published_time" content="{{ $meta_time }}">
    <meta property="article:section" content="blog">
    <meta property="og:description"
        content="{{ strip_tags(trim(utf8_decode($meta_description))) }}" />
    ...
    <script data-cfasync="true" type="application/ld+json">
        {"@context":"http:\/\/schema.org","@type":"WebSite","@id":"#website","url":"https:\/\/www.lindaikejisblog.com\/","name":"Linda Ikeji&#039;s Blog | News, blog, politics, gossip, Events, Entertainment, Lifestyle, Fashion, Beauty, Inspiration","potentialAction":{"@type":"SearchAction","target":"https:\/\/www.lindaikejisblog.com\/search\/result\/?search={search_term_string}","query-input":"required name=search_term_string"}}
    </script>
    <script data-cfasync="true" type="application/ld+json">
        {"@context":"http:\/\/schema.org","@type":"Organization","url":"{{ \Illuminate\Support\Facades\Request::url() }}","sameAs":["https:\/\/www.facebook.com\/LindaIkejiBlog","https:\/\/twitter.com\/lindaikeji"],"@id":"#organization","name":"Linda Ikeji&#039;s Blog","logo":"http://www.lindaikejisblog.com/img/favicon.png"}
    </script>
    {{--<link rel="manifest" href="/manifest.json">--}}
    {{--<link rel="amphtml" href="{{ str_replace("www.","amp.",url('/')) }}">--}}
    <link rel="stylesheet" href="{{ url('/css/bootstrap.min.css') }}">
    <link rel="icon" type="image/png" href="https://www.lindaikejisblog.com/img/favicon.png">
    <link rel="shortcut icon" sizes="16x16" href="https://www.lindaikejisblog.com/img/favicon.png">
    ...
    <link rel="manifest" href="https://www.lindaikejisblog.com/manifest.json">
    <!-- Chrome for Android theme color -->
    <meta name="theme-color" content="#000000">

    <!-- Add to homescreen for Chrome on Android -->
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="application-name" content="lindaikejisblog">
    <link rel="icon" sizes="512x512" href="/img/favicon.png">

    <!-- Add to homescreen for Safari on iOS -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="lindaikejisblog">
    ...
    <!-- Tile for Win8 -->
    <meta name="msapplication-TileColor" content="#91142f">
    ...
    <script type='text/javascript'
        src='//platform-api.sharethis.com/js/sharethis.js#property=5ce4a13a7ff0c00012df0e12&product=social-ab'
        async='async'></script>
</head>
...
{{ str_replace('alexis','www',background()) }}
    ...
    <div class="header">
        <div class="date">
            ...
            <ul>
                <li>
                    <a href="https://www.youtube.com/channel/UCj-Ur2GPU_bVKQmktoxx3mw"
                        target="_blank"><img src="{{ url('/img/oplay.png') }}" style="height: 20px;"
                            alt="">LindaIkejiTV</a>
                </li>
                <li>
                    <a href="https://instagram.com/lindaikejiblogofficial?utm_source=ig_profile_share&igshid=1oynhpuy31jwd"
                        target="_blank"><img src="{{ url('/instagram.png') }}" alt=""></a>
                </li>
                {{--<li>--}}
                {{--<a href="https://www.lindaikejisocial.com/" target="_blank"><img src="{{ url('/img/lis_favicon.ico') }}"
                style="height: 20px;" alt="">LindaIkejiSocial</a>--}}
                {{--</li>--}}
                <li>
                    <a target="_blank" href="javascript:;" data-toggle="modal"
                        data-target="#ads"><img src="{{ url('/img/advert.png') }}"
                            style="height: 20px;" alt="">Advert enquiry</a>
                </li>
                <li>
                        <a href="javascript:;" data-toggle="modal" data-target="#contactus">News/Tip-off</a>
                </li>
            </ul>
        </div>
        ...
        <div class="blog_title">
            <div class="signage">
                <h3><a href="{{ url('/') }}" style="color: #fff;text-decoration: none;">Welcome to
                ...
                <div class="form_group">
                    <form action="{{ url('/search/result') }}" method="get">
                        <input type="text" name="search" class="form-control"
                            placeholder="Search Linda Ikeji's Blog">
                    </form>
                </div>
            </div>
        ...
        <div class="container">
            <ul>
                <li><a href="javascript:;" data-toggle="modal"
                        data-target="#contactus">News/Tip-off</a></li>
                <li><a href="javascript:;" data-toggle="modal" data-target="#ads">Advertise with
                        us</a></li>
            </ul>
        </div>
        <div class="last_line">
    ...
    <noscript id="deferred-styles">
        <link rel="stylesheet" href="{{ url('/css/animate.css?v='.rand(1000, 1000000).'.0') }}">
        <link rel="stylesheet"
            href="{{ url('/css/icon/css/font-awesome.min.css?v='.rand(1000, 1000000).'.0') }}">
        <link rel="stylesheet"
            href="{{ url('/js/vendor/flexslider.css?v='.rand(1000, 1000000).'.0') }}">
...
function validateEmail(a){var n=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return n.test(a)}function changeData(){$(".ano").toggle("slow"),$("#anono").val("1")}function changeUrl(a){window.location=a}
    ...
    <script data-cfasync="true" async src="https://cdn.onesignal.com/sdks/OneSignalSDK.js" async>
    </script>
    <script data-cfasync="true">
