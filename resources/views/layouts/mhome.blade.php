...
<head>
    ...
    <link rel="canonical" href="{{ str_replace("amp.","www.",\Illuminate\Support\Facades\Request::url()) }}"/>
    ...
    <link rel="icon"
          type="image/png"
          href="http://www.lindaikejisblog.com/img/favicon.png">
...
<style amp-custom>
    .page{
    background: url(@if(!background())
                       {{ url('/img/background.jpg') }}
                    @else
                        {{ background() }}
                    @endif ) repeat;background-size: contain;
}
    .header_im{
    height: 20px;
    }
    ...
    .img_view{
    overflow: hidden;max-height: 333px;
    }
    .story_description{
    ...
    .btnui{
    background: #890e2a;margin-left:18px;border: #890e2a;padding: 1px 5px;font-size: 9px;line-height: 1.5;
    }
</style>
</head>
...
<div class="header">
    <div class="date">
        ...
        <ul>
            <li>
                <a href="https://www.youtube.com/channel/UCj-Ur2GPU_bVKQmktoxx3mw" target="_blank"><img src="{{ url('/img/oplay.png') }}" layout='responsive' class="header_im" height="20"  alt="">LindaIkejiTV</a>
            </li>
            {{--<li>--}}
            {{--<a href="http://www.lindaikejimusic.com" target="_blank"><img src="{{ url('/img/music.png') }}" alt="">LindaIkejiMusic</a>--}}
            {{--</li>--}}
            <li>
                <a href="https://www.lindaikejisocial.com/" target="_blank"><img src="{{ url('/img/lis_favicon.ico') }}" layout='responsive' class="header_im" height="20" alt="">LindaIkejiSocial</a>
            </li>
            <li>
                <a  target="_blank" href="javascript:;" data-toggle="modal" data-target="#ads"><img src="{{ url('/img/advert.png') }}" layout='responsive' height="20" class="header_im" alt="">Advert enquiry</a>
            </li>
        </ul>
    </div>
    <div class="blog_title">
        ...
        <div class="search_btn">
            <img class="default" layout='responsive' height="50" src="{{ url('/images/icon_search.png') }}" alt="">
            <img class="searching" layout='responsive' height="50" src="{{ url('/images/icon_close.png') }}" alt="">
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Contact us via email:  Lindaikeji@gmail.com</p>
            </div>
        </div>
